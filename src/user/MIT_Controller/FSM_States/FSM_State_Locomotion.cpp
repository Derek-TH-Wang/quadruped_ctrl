...
void FSM_State_Locomotion<T>::LocomotionControlStep() {
  ...
  for (int leg(0); leg < 4; ++leg) {
    // derektodo:
    this->_data->_legController->commands[leg].pDes[2] += 0.0;
    ...
    // std::cout << "pDes = " << this->_data->_legController->commands[leg].pDes[0]
    //           << " " << this->_data->_legController->commands[leg].pDes[1]
    //           << " " << this->_data->_legController->commands[leg].pDes[2]
    //           << std::endl;
    // std::cout << "vDes = " << this->_data->_legController->commands[leg].vDes
    // << std::endl; std::cout << "kpCartesian = " <<
    // this->_data->_legController->commands[leg].kpCartesian << std::endl;
    // std::cout << "kdCartesian = " <<
    // this->_data->_legController->commands[leg].kdCartesian << std::endl;

    // std::cout << this->_data->_legController->commands[leg].pDes[2] << " ";
  }
  // std::cout << this->_data->_legController->commands[0].pDes[0] << " " << this->_data->_legController->commands[0].pDes[1] << " " << this->_data->_legController->commands[0].pDes[2];
  // std::cout << std::endl;
  ...
  for (int leg(0); leg < 4; ++leg) {
    ...
    // std::cout << "pDes1 = " <<
    // this->_data->_legController->commands[leg].pDes << std::endl; std::cout
    // << "vDes 1= " << this->_data->_legController->commands[leg].vDes <<
    // std::endl; std::cout << "kpCartesian1 = " <<
    // this->_data->_legController->commands[leg].kpCartesian << std::endl;
    // std::cout << "kdCartesian1 = " <<
    // this->_data->_legController->commands[leg].kdCartesian << std::endl;
  }
}
