...
Quadruped<T> buildMiniCheetah() {
  ...
  cheetah._bodyMass = 4.267;
  cheetah._bodyLength = 0.189 * 2;
  cheetah._bodyWidth = 0.0495 * 2;
  cheetah._bodyHeight = 0.05 * 2;
  cheetah._abadGearRatio = 6;
  cheetah._hipGearRatio = 6;
  cheetah._kneeGearRatio = 9.47;
  cheetah._abadLinkLength = 0.0671;
  cheetah._hipLinkLength = 0.206;
  ...
  abadRotationalInertia << 566, 0, 0, 0, 309, 0, 0, 0, 309;
  abadRotationalInertia = abadRotationalInertia * 1e-6;
  Vec3<T> abadCOM(0, 0, 0);  // LEFT
  SpatialInertia<T> abadInertia(0.517, abadCOM, abadRotationalInertia);

  Mat3<T> hipRotationalInertia;
  hipRotationalInertia << 1983, 245, 13, 245, 2103, 1.5, 13, 1.5, 408;
  hipRotationalInertia = hipRotationalInertia * 1e-6;
  Vec3<T> hipCOM(0, 0, -0.02);
  SpatialInertia<T> hipInertia(0.729, hipCOM, hipRotationalInertia);
  ...
  bodyRotationalInertia << 18807, 0, 0, 0, 29242, 0, 0, 0, 40091;
  ...
  // locations
  cheetah._abadRotorLocation = Vec3<T>(0.107, 0.049, 0);
